package com.example.behavioral.interpreter.employee.domain;
...
public abstract class Employee {
    ...
    protected Employee(long employeeId, String employeeName, String designation, Department department, int salary) {
        super();
