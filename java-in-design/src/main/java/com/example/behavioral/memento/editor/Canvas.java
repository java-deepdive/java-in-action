...
import com.example.behavioral.memento.commands.ColorCommand;
import com.example.behavioral.memento.commands.Command;
import com.example.behavioral.memento.commands.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (target != null) {
                    Command command = new ColorCommand(editor, new Color((int) (Math.random() * 0x1000000)));
