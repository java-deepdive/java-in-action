package kr.seok.bowling.v1.domain.score;


import kr.seok.bowling.v1.domain.Left;
import kr.seok.bowling.v1.domain.engine.State;
import kr.seok.bowling.v1.domain.pin.Pin;
import kr.seok.bowling.v1.domain.state.StateSymbol;
import kr.seok.bowling.v1.exception.PinsOutOfSizeException;

import static kr.seok.bowling.v1.domain.pin.Pin.BOWLING_PIN_MIN_SIZE;
